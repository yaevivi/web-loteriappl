...
# Configuración
URL = "https://bolitadivinanza.com/miami-fla/"
JSON_FILENAME = "data/miami_fla.json"
HEADERS = {"User-Agent": "Mozilla/5.0"}

def obtener_y_guardar_miami_fla():
    # Descargar HTML
    ...
    if not summary_tag:
        os.remove(HTML_FILENAME)
        return "No se encontró el contenido del <summary>."
...
#    print(obtener_y_guardar_miami_fla())
